...
func SetupOTelSDK(ctx context.Context, env *config.Config) (shutdown func(context.Context) error, err error) {
	...
	res, err := resource.New(ctx,
		resource.WithAttributes(
			...
			semconv.ServiceVersionKey.String(constants.SERVICE_NAME),
...
func newTracerProvider(ctx context.Context, env *config.Config, res *resource.Resource) (*trace.TracerProvider, error) {
...
func newMeterProvider(env *config.Config, res *resource.Resource) (*metric.MeterProvider, error) {
	endpoint := formatEndpoint(env.ObservabilityUrl)
...
func newLoggerProvider(ctx context.Context, env *config.Config, res *resource.Resource) (*log.LoggerProvider, error) {
	endpoint := formatEndpoint(env.ObservabilityUrl)
