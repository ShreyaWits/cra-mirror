...
func TestMetricsService(t *testing.T) {
	...
	// Test with nil attributes (should handle gracefully)
	assert.NotPanics(t, func() {
		disabledMetrics.IncrementCounter(ctx, "nil_attrs", 1, nil)
		disabledMetrics.RecordHistogram(ctx, "nil_attrs", 42.0, nil)
	})
}
