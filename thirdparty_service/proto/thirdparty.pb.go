...
// --- Twilio WhatsApp ---
type InvokeWhatsAppRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Phone         string                 `protobuf:"bytes,1,opt,name=phone,proto3" json:"phone,omitempty"`
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	CountryCode   string                 `protobuf:"bytes,3,opt,name=country_code,json=countryCode,proto3" json:"country_code,omitempty"`
...
func (x *InvokeWhatsAppRequest) Reset() {
	*x = InvokeWhatsAppRequest{}
	mi := &file_thirdparty_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InvokeWhatsAppRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InvokeWhatsAppRequest) ProtoMessage() {}

func (x *InvokeWhatsAppRequest) ProtoReflect() protoreflect.Message {
	mi := &file_thirdparty_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InvokeWhatsAppRequest.ProtoReflect.Descriptor instead.
func (*InvokeWhatsAppRequest) Descriptor() ([]byte, []int) {
	return file_thirdparty_proto_rawDescGZIP(), []int{2}
}

func (x *InvokeWhatsAppRequest) GetPhone() string {
	if x != nil {
		return x.Phone
	}
	return ""
...
func (x *InvokeWhatsAppRequest) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *InvokeWhatsAppRequest) GetCountryCode() string {
	if x != nil {
		return x.CountryCode
	}
	return ""
...
type InvokeWhatsAppResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Code          string                 `protobuf:"bytes,1,opt,name=code,proto3" json:"code,omitempty"`
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *InvokeWhatsAppResponse) Reset() {
	*x = InvokeWhatsAppResponse{}
	mi := &file_thirdparty_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InvokeWhatsAppResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InvokeWhatsAppResponse) ProtoMessage() {}

func (x *InvokeWhatsAppResponse) ProtoReflect() protoreflect.Message {
	mi := &file_thirdparty_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InvokeWhatsAppResponse.ProtoReflect.Descriptor instead.
func (*InvokeWhatsAppResponse) Descriptor() ([]byte, []int) {
	return file_thirdparty_proto_rawDescGZIP(), []int{3}
}

func (x *InvokeWhatsAppResponse) GetCode() string {
	if x != nil {
		return x.Code
	}
	return ""
...
func (x *InvokeWhatsAppResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
type InvokeSendGridRequest struct {
	...
	Type          string                 `protobuf:"bytes,4,opt,name=type,proto3" json:"type,omitempty"` // e.g., "text/plain" or "text/html"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_thirdparty_proto_rawDesc = "" +
	"\n" +
	"\x10thirdparty.proto\x12\x02pb\"h\n" +
	...
	"\x15InvokeWhatsAppRequest\x12\x14\n" +
	"\x05phone\x18\x01 \x01(\tR\x05phone\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12!\n" +
...
var (
	...
	file_thirdparty_proto_rawDescData []byte
)

func file_thirdparty_proto_rawDescGZIP() []byte {
	file_thirdparty_proto_rawDescOnce.Do(func() {
		file_thirdparty_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_thirdparty_proto_rawDesc), len(file_thirdparty_proto_rawDesc)))
	})
