...
// 		CacheTtl:    (240 * time.Hour).String(),
// 	}

// 	// Use interface type for cache argument if NewTemplateService expects *cacheclient.RedisClientStruct
// 	svc := NewTemplateService(mockRepo, mockCache, obs, cfg)
...
// 	mockCache := new(MockCache)
// 	obs := &observability.ObservabilityStack{}
// 	svc := NewTemplateService(mockRepo, mockCache, obs)
...
// func TestUpdateTemplate_RepoError_Fail(t *testing.T) {
// 	mockRepo := new(MockRepo)
// 	mockCache := new(MockCache)
// 	obs := &observability.ObservabilityStack{}
// 	svc := NewTemplateService(mockRepo, mockCache, obs)
...
// 	// (implementation of TestCreateTemplate_CacheSetError goes here, or remove if not needed)
// }

// // TestDeleteTemplate_Success tests successful deletion of a template.
