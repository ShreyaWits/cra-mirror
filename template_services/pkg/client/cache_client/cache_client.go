...
import (
	"context"
	"fmt"
	pb "template-services/proto/redis_service"
	"time"
...
type CacheServiceClientFactory func(conn *grpc.ClientConn) interface{}

// DefaultCacheServiceClientFactory is the default factory for creating a CacheServiceClient
func DefaultCacheServiceClientFactory(conn *grpc.ClientConn) interface{} {
	return pb.NewCacheServiceClient(conn) // Ensure pb.CacheServiceClient is generated and imported correctly
}
...
func (c *RedisClientStruct) SetCache(ctx context.Context, namespace, key, value string, ttl time.Duration) error {
	...
	resp, err := client.SetCache(ctx, req)
	if err != nil {
...
func (c *RedisClientStruct) GetCache(ctx context.Context, namespace, key string) (string, bool, error) {
	...
	resp, err := client.GetCache(ctx, req)
	if err != nil {
...
func (c *RedisClientStruct) InvalidateCache(ctx context.Context, namespace, key string) error {
	...
	resp, err := client.InvalidateCache(ctx, req)
	if err != nil {
