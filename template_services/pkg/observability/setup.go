...
func SetupOTelSDK(ctx context.Context, env *configEnv.Config) (shutdown func(context.Context) error, err error) {
	...
	res, err := resource.New(ctx,
		resource.WithAttributes(
			...
			semconv.ServiceVersionKey.String(constants.ServiceVersion),
...
func newTracerProvider(ctx context.Context, env *configEnv.Config, res *resource.Resource) (*trace.TracerProvider, error) {
...
func newMeterProvider(env *configEnv.Config, res *resource.Resource) (*metric.MeterProvider, error) {
	endpoint := formatEndpoint(env.ObservabilityUrl)
	fmt.Printf("Setting up meter provider with endpoint: %s\n", endpoint)
...
func newLoggerProvider(ctx context.Context, env *configEnv.Config, res *resource.Resource) (*log.LoggerProvider, error) {
	endpoint := formatEndpoint(env.ObservabilityUrl)
