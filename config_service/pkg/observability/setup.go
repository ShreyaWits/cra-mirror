...
func SetupOTelSDK(ctx context.Context, env *configs.Config) (shutdown func(context.Context) error, err error) {
	var shutdownFuncs []func(context.Context) error

	// Print environment info for debugging
	fmt.Printf("Setting up OpenTelemetry SDK with observability URL: %s\n", env.OtelCollectorGrpcEndpoint)
...
func newTracerProvider(ctx context.Context, env *configs.Config, res *resource.Resource) (*trace.TracerProvider, error) {
	endpoint := env.OtelCollectorGrpcEndpoint
...
func newMeterProvider(env *configs.Config, res *resource.Resource) (*metric.MeterProvider, error) {
	endpoint := env.OtelCollectorGrpcEndpoint
...
func newLoggerProvider(ctx context.Context, env *configs.Config, res *resource.Resource) (*log.LoggerProvider, error) {
	endpoint := env.OtelCollectorGrpcEndpoint
